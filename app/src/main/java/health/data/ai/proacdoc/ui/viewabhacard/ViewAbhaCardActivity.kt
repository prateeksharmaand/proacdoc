...
package health.data.ai.proacdoc.ui.viewabhacard
...
import health.care.ai.proacdoc.databinding.ActivityViewAbhaCardBinding
...
class ViewAbhaCardActivity : AppCompatActivity() {
    private lateinit var binding: ActivityViewAbhaCardBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityViewAbhaCardBinding.inflate(layoutInflater)
    ...
    fun initObserver() {
        ...
        abhaViewModel.getabhaUserTokenresponse.observe(this, Observer {
            ...
            abhaViewModel.GetAbhaUserCard("Bearer $abhaToken", "Bearer " + it.accessToken)
        })
