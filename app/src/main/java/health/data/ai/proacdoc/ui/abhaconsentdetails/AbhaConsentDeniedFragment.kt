...
class AbhaConsentDeniedFragment : Fragment() {
    ...
    private val instance: AbhaConsentDeniedFragment? = null
    ...
    fun initObserver() {
        ...
        abhaViewModel.getabhaUserTokenresponse.observe(viewLifecycleOwner) {
            ...
            abhaViewModel.getConsentsByTypeDenied(
                "DENIED",
                "Bearer $abhaToken",
        ...
        abhaViewModel.abhaConsentDeniedListDetailsresponse.observe(viewLifecycleOwner){
