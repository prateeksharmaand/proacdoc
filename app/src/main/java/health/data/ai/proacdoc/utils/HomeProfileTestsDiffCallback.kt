...
class HomeProfileTestsDiffCallback(oldEmployeeList: List<Data>, newEmployeeList: List<Data>) :
    DiffUtil.Callback() {
    ...
    override fun areItemsTheSame(oldItemPosition: Int, newItemPosition: Int): Boolean {
        return mOldEmployeeList[oldItemPosition].code == mNewEmployeeList[newItemPosition].code&&mOldEmployeeList[oldItemPosition].testlist == mNewEmployeeList[newItemPosition].testlist
    }
