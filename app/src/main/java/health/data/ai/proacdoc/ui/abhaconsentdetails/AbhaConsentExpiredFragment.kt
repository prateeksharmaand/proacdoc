...
class AbhaConsentExpiredFragment : Fragment() {
    ...
    fun initObserver() {
        ...
        abhaViewModel.getabhaUserTokenresponse.observe(viewLifecycleOwner) {
            ...
            abhaViewModel.getConsentsByTypeExpired(
                "EXPIRED",
                "Bearer $abhaToken",
        ...
        abhaViewModel.abhaConsentExpiredListDetailsresponse.observe(viewLifecycleOwner) {
