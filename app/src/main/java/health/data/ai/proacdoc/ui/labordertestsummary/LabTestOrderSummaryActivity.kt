package health.data.ai.proacdoc.ui.labordertestsummary
...
import health.care.ai.proacdoc.databinding.ActivityLabOrderSummaryBinding
...
import health.data.ai.proacdoc.ui.adapters.BenificiariesOrderSummaryListAdapter
import health.data.ai.proacdoc.ui.homefragment.LabTestViewModel
import health.data.ai.proacdoc.ui.labordersummarypdf.LabTestOrderSummaryPDFActivity
...
class LabTestOrderSummaryActivity : AppCompatActivity() {
    ...
    fun initObserver() {
        ...
        val record = intent.extras!!.get("record") as health.data.ai.proacdoc.api.models.mylaborders.Data
