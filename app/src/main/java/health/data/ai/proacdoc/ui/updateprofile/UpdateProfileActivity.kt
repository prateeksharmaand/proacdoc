...
package health.data.ai.proacdoc.ui.updateprofile
...
import health.care.ai.proacdoc.databinding.ActivityUpdateprofileBinding
        ...
        binding.UpdateNow.setOnClickListener {
            if (binding.etName.text?.isEmpty() == true) {
                ...
                val updateProfileModel =
                    health.data.ai.proacdoc.api.models.login.profile.UpdateProfileRequest()
