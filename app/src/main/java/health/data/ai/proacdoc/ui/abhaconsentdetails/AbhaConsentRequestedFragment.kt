...
class AbhaConsentRequestedFragment : Fragment() {
    ...
    fun initObserver() {
        ...
        abhaViewModel.getabhaUserTokenresponse.observe(viewLifecycleOwner) {
            abhaViewModel.getConsentsByTypeRequested(
                "REQUESTED",
                "Bearer $abhaToken",
        ...
        abhaViewModel.abhaConsentrequestedListDetailsresponse.observe(viewLifecycleOwner) {
