/*************************************************
 * Created by Efendi Hariyadi on 09/08/22, 9:15 PM
 * Copyright (c) 2022 . All rights reserved.
 * Last modified 09/08/22, 9:12 PM
 ************************************************/

package health.care.ai.heartmonitor.camera
...
class CameraPostLolipop internal constructor(context: Context) : CameraSupport() {
    ...
    override fun open(cameraId: Int): CameraSupport {
        try {
            ...
            manager.openCamera(this.cameraId.toString(), object : CameraDevice.StateCallback() {
