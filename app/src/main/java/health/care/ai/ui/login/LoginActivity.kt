...
import health.care.ai.databinding.ActivityLoginBinding
import health.care.ai.ui.home.HomeActivity
import health.care.ai.ui.mobilenumber.MobileNumberActivity
import health.care.ai.ui.privacy.PrivacyPolicyActivity
    ...
    private fun UpdateUI(account: GoogleSignInAccount) {
        ...
        firebaseAuth.signInWithCredential(credential).addOnCompleteListener { task ->
            if (task.isSuccessful) {
                ...
                var user = health.care.ai.api.models.User.UserModel()
