package health.care.ai.ui.labtestfinaldetails
        ...
        binding.btnPlaceOrder.setOnClickListener(View.OnClickListener {
            ...
            if (isSuccess) {
                ...
                if (bneiList.isNullOrEmpty()) {
                    ...
                    val appointMentSlot: health.care.ai.api.models.appointmentslots.Data =
                        spinnerAppointmentSlot.selectedItem as health.care.ai.api.models.appointmentslots.Data
